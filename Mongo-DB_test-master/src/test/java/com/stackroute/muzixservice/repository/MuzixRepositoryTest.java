...
public class MuzixRepositoryTest {
    ...
    public void testSaveTrack() {
        ...
        Muzix fetchMuzix = (Muzix) muzixRepository.findById(muzix.getTrackId()).get();
    ...
    public void testSaveTrackFailure() {
        ...
        muzixRepository.save(muzix);
        Muzix fetchUser = (Muzix) muzixRepository.findById(muzix.getTrackId()).get();
    ...
    @Test
    public void testDisplyTrackById_givenTrackDetails_shouldDisplayTrack() {
        Muzix muzix = new Muzix(1, "pal pal pal", "awesome");
        muzixRepository.save(muzix);
        Muzix muzix1= (Muzix) muzixRepository.findById(1).get();
        System.out.println("aaaaaaaaaaa" + muzix1);
        Assert.assertEquals(muzix,muzix1);
    }
    @Test(expected= TrackNotFoundException.class)
    public void testDisplyTrackByIdFailure_givenTrackDetails_shouldDisplayTrack() {
        Muzix muzix = new Muzix(1, "pal pal pal", "awesome");
        muzixRepository.save(muzix);
        Muzix muzix1= (Muzix) muzixRepository.findById(2).get();
        System.out.println("aaaaaaaaaaa" + muzix1);
